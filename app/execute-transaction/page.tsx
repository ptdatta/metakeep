...
const Transaction = () => {
  ...
  const getTransactionData = async (transactionData: ContractFunction) => {
    ...
    const provider = new ethers.JsonRpcProvider(
      transactionData.contract.rpcUrl
    );
    ...
    if (
      !transactionData.contract.contractABIFunc ||
    ...
    const iface = new ethers.Interface(
      transactionData.contract.contractABIFunc as ethers.InterfaceAbi
    );
        ...
        {loading ? (
          ...
          <div className="p-6 border rounded-lg shadow-md bg-white max-w-4xl w-full">
            <p className="text-green-600 font-medium mb-2">
              ✅ Your transaction is successfully signed!
            </p>
          ...
          <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-gray-300 w-full p-4 rounded-2xl">
                <div>
                  <p>
                    ...
                    {transactionData?.contract.contractAddress}
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    {JSON.stringify(transactionData?.params)}
                  </p>
                  <p>
                    <strong>Chain ID:</strong>{" "}
                    {transactionData?.contract.chainId}
                  </p>
                  <p>
                    <strong>RPC URL:</strong> {transactionData?.contract.rpcUrl}
                  </p>
                </div>
              </div>
            </div>
            ...
            <Button
              onClick={() => signTransaction(transaction, provider!)}
